...
import {useAnchorContext} from '../context/AnchorContext';
...
function setPopupPosition(
  ...
  let left = rect.left + window.pageXOffset - editor.offsetWidth + rect.width;
...
function useTextFormatFloatingToolbar(
  ...
  const {element} = useAnchorContext();
